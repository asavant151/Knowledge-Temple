...
const CourseDetail = () => {
  ...
  const course = {
    ...
    price: "$149",
    discountPrice: "$99",
    description: "Master modern JavaScript frameworks and build interactive web applications with this comprehensive course. Learn from industry experts and gain hands-on experience with real-world projects.",
    ...
    instructorBio: "Senior JavaScript Developer with 10+ years of experience working at Google and Facebook. Specializes in React and Node.js.",
    requirements: [
    ...
    curriculum: [
      {
        ...
        lectures: [
          ...
          { title: "Setting Up Your Environment", duration: "18:30", type: "video" },
          { title: "JavaScript Fundamentals Review", duration: "25:15", type: "video" },
          { title: "Exercise: Basic JS Challenges", duration: "Practice", type: "exercise" }
        ]
      },
      {
        section: "Modern JavaScript",
        lectures: [
          { title: "ES6+ Features Deep Dive", duration: "42:20", type: "video" },
          { title: "Working with Modules", duration: "28:10", type: "video" },
          { title: "Asynchronous JavaScript", duration: "35:45", type: "video" },
          { title: "Exercise: Async Challenges", duration: "Practice", type: "exercise" }
        ]
      },
            ...
            <div className="flex items-center">
              <div className="flex items-center mr-2">
                {[...Array(5)].map((_, i) => (
                  <Star 
                    key={i} 
                    className={`w-5 h-5 ${i < Math.floor(course.rating) ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'}`} 
                  />
                ))}
              </div>
              <span className="font-semibold">{course.rating}</span>
              <span className="text-gray-500 ml-1">({course.reviews.toLocaleString()} reviews)</span>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
              <div className="border-b border-gray-200">
                <nav className="flex -mb-px">
                  <button className="py-4 px-6 border-b-2 border-blue-600 font-medium text-blue-600">
                    Overview
                  </button>
                  ...
                  {course.curriculum.map((section, sectionIndex) => (
                    <div key={sectionIndex} className="border-b border-gray-200 last:border-b-0">
                      <div className="bg-gray-50 px-4 py-3 flex justify-between items-center">
                        ...
                        <span className="text-sm text-gray-500">{section.lectures.length} lectures • 42 min</span>
                      </div>
                      <div className="divide-y divide-gray-200">
                        {section.lectures.map((lecture, lectureIndex) => (
                          <div key={lectureIndex} className="px-4 py-3 flex justify-between items-center hover:bg-gray-50">
                            <div className="flex items-center">
                              {lecture.type === "video" ? (
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center text-gray-500">
                    ...
                    <span className="font-semibold text-gray-900 mr-2">{course.rating} Instructor Rating</span>
